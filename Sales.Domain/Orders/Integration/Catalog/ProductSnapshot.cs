...
public sealed class ProductSnapshot : ValueObject
{
    ...
    public ProductSnapshot(Guid productId, string productName, decimal unitPrice)
    {
        ...
        Guard.AgainstNullOrWhiteSpace(productName, nameof(productName), "Nome do produto é obrigatório.");
        Guard.Against<DomainException>(unitPrice <= 0, "UnitPrice inválido.");
